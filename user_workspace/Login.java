...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Would you forget your password ?");

        jToggleButton3.setBackground(new java.awt.Color(255, 153, 51));
        jToggleButton3.setForeground(new java.awt.Color(255, 255, 255));
        jToggleButton3.setText("Forget Pass");

        jPanel2.setBackground(new java.awt.Color(153, 255, 255));
        jPanel2.setForeground(new java.awt.Color(153, 255, 255));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/user_workspace/ZenBus.png"))); // NOI18N
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        if (Username.contains("Swadhin") && Password.contains("123456")) {
            user.setText("");
            pass.setText("");
